...
// Header component handles --panel-bg, --bg-top, --bg-bottom, --panel-opacity on mount

export const Background: React.FC = () => {
  // Theme init handled by Header component on mount
  ...
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none" style={{ zIndex: 0 }}>
      ...
      {/* Orb 5 */}
      <div
        className="orb-5 absolute rounded-full blur-3xl"
        style={{
      ...
      {/* Orb 6 */}
      <div
        className="orb-6 absolute rounded-full blur-3xl"
        style={{
