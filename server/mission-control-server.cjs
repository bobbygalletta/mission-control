#!/usr/bin/env node
// Mission Control Server - Separate from Agent Chat
// Serves only Mission Control on port 8787
...
server.listen(PORT, '0.0.0.0', () => {
  console.log(`[${new Date().toISOString()}] Mission Control server running on http://0.0.0.0:${PORT}`);
});
